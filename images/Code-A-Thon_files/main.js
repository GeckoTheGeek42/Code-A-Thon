...
var main = (function($) {
    var _ = {
            ...
            _.$thumbnails.children()
                .each(function() {
                    ...
                    var $this = $(this),
                        ...
                        $levelFrame = $this.children('.levelframe'),
                        s;
        ...
        init: function() {
            ...
            _.firstLaunch = localStorage.firstLaunch == "yes" || localStorage.firstLaunch == undefined;
            if (_.firstLaunch) {
                localStorage.finished = "[]";
                localStorage.score = "0";
            }
            score = JSON.parse(localStorage.score);
            finished = JSON.parse(localStorage.finished);
